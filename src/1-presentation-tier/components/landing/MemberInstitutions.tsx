    ...
    >      
      <div className="mx-auto max-w-[1600px] px-4 md:px-8 xl:px-12">
        ...
        <div className="relative w-full overflow-hidden [mask-image:linear-gradient(to_right,transparent,black_4%,black_96%,transparent)]">
          <div
            // Replaced inline styles with w-max, animate-marquee-scroll, and conditionally applied pause-animation
            className={`flex w-max items-center gap-4 py-2 animate-marquee-scroll ${
              isMarqueePaused ? 'pause-animation' : ''
            }`}
