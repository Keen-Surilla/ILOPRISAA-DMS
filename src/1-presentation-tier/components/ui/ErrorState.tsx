// src/1-presentation-tier/components/ui/ErrorState.tsx
...
export function ErrorState({
  ...
  message = "We couldn't connect to the server right now. Please refresh the page or try again in a few moments.",
  onRetry,
}: ErrorStateProps) {
  return (
